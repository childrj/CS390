...
public:
	...
	//get a fragment of a wave file
	//begin is the start of the fragment
	//end is the end of the fragment
	WaveFile * get_fragment(double begin, double end);
	//Remove a fragment of the wave file
	//begin is the beginning of the fragment to be removed
	//end is the end of the fragment
